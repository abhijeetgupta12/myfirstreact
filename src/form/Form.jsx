...
const Form = () => {
    ...
    const HandleEvent = (event) =>{//this 'event' belongs to that input tag whose onChange method is invoked.
    ...
    const HandleSubmit =(event) =>{
        ...
        alert(`${state.fullname} ${state.email} ${state.phone} ${state.message}`)//access the data like this
    ...
    return(
        ...
        <form onSubmit={HandleSubmit}>
            ...
            <input type='text' name='fullname' value={state.fullname} onChange={HandleEvent}/><br/><br/>

            <label>Email :</label><br/>
            <input type='email' name='email' value={state.email} onChange={HandleEvent}/><br/><br/>

            <label>Phone :</label><br/>
            <input type='tel' name='phone' value={state.phone} onChange={HandleEvent}/><br/><br/>

            <label>Message :</label><br/>
            <textarea name='message' value={state.message} onChange={HandleEvent}/><br/><br/>
